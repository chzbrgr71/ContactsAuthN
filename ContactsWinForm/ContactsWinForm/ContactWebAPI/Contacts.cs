...
using ContactsWinForm.Models;
using Microsoft.Rest;
using Newtonsoft.Json.Linq;

namespace ContactsWinForm
{
    internal partial class Contacts : IServiceOperations<ContactWebAPI>, IContacts
    {
        /// <summary>
        ...
        /// </param>
        internal Contacts(ContactWebAPI client)
        {
            this._client = client;
        }
        
        private ContactWebAPI _client;
        
        /// <summary>
        /// Gets a reference to the ContactsWinForm.ContactWebAPI.
        /// </summary>
        public ContactWebAPI Client
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> PostByContactWithOperationResponseAsync(Contact contact, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (contact == null)
            {
