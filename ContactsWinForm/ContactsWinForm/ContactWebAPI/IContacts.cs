...
namespace ContactsWinForm
{
    public partial interface IContacts
    {
        ...
        /// Cancellation token.
        /// </param>
        Task<HttpOperationResponse<string>> PostByContactWithOperationResponseAsync(Contact contact, CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    }
}
