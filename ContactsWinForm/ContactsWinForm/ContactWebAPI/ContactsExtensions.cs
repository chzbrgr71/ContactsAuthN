...
namespace ContactsWinForm
{
    public static partial class ContactsExtensions
    {
        ...
        /// Reference to the ContactsWinForm.IContacts.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<ContactsWinForm.Models.Contact>> result = await operations.GetWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
